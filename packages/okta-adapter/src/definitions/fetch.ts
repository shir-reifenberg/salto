...
import { addSchemaIdToUserType, addSchemaIdToUserType2 } from './transforms/user_type'
...
> => ({
        ...
        ...(includeProfileMappingProperties
          ? {
              properties: {
                ...
                context: { args: { id: { transformation: { root: 'id' } } } },
              },
            }
          : {}),
      },
  ...
  Brand: {
    ...
    resource: {
      ...
      recurseInto: {
        themes: {
          typeName: 'BrandTheme',
          context: { args: { brandId: { transformation: { root: 'id' } } } },
        },
      },
    },
    element: {
  ...
  UserType: {
    ...
    resource: {
      ...
      recurseInto: {
        schema: {
          typeName: 'UserSchema',
          context: { args: { id: { transformation: { adjust: addSchemaIdToUserType2 } } } },
        },
      },
    },
    element: {
  ...
  UserSchema: {
    requests: [
      {
        ...
        transformation: {
          ...
          adjust: ({ value, context }) => ({ value: { ...(isObject(value) ? { ...value, id: context.id } : {}) } }),
        },
      },
    ],
    resource: { directFetch: false },
    element: {
      ...
      fieldCustomizations: {
        id: { hide: true },
        [naclCase('$schema')]: { omit: true }, // TODOS - it doesnt work with nacl case for some reason
        _links: { omit: true },
        type: { omit: true },
        title: { omit: true },
    ...
    resource: {
      ...
      recurseInto: {
        policyRules: {
          ...
          context: { args: { policyId: { transformation: { root: 'id' } } } },
        },
      },
    },
    element: {
